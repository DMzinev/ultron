...
│
├── tests/                       # 812+ automated tests partitioned across boundaries
...
3. **Single Source-of-Truth Test Gate**: All verification executes through `python scripts/verify.py`, running 812+ tests with greppable output and clean JSON serialization.
